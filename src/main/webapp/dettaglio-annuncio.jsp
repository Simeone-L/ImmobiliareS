...
<body>
    ...
    <div style="float: right; width: 45%; ">
        <div class="container">
            ...
            <div>
                <p style="font-size: 40px; display: inline;">Prezzo: </p>
                <!--inserire prezzo--> ${annuncio.immobile.prezzo }
            </div>
        </div>
    </div>
...
>>>>>>> branch 'master' of https://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@github.com/Simeone-L/ImmobiliareS.git
</html>